...
class ControleTelaAdministracaoUsuario{
  ...
  ControleTelaAdministracaoUsuario(this.context);
  ...
  void removerUsuario(int index) async{
    ...
    if (qt_patrimonios! > 0){
      MensagemAlerta(context, "Não é possível excluir o usuário (existem patrimônios vinculadoss a esse usuário) ");
    } else {
      ...
      if(usuario_logado!.id == usuario_a_ser_excluido.id){
        MensagemAlerta(context, "Não é possível excluir o usuário atualmente logado ");
      } else {
